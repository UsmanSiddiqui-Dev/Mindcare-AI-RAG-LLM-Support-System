  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center py-12 px-4">
      ...
      >
        ...
        >
          <div className="absolute -inset-4 bg-brand-500 rounded-full blur-lg opacity-20"></div>
          <div className="relative flex justify-center">
            <motion.div
              className="h-24 w-24 bg-brand-600 rounded-full flex items-center justify-center"
      ...
      >
        {[
          ...
          >
            <div className="h-16 w-16 bg-brand-50 rounded-xl flex items-center justify-center mb-6 text-brand-600">
              {feature.icon}
            </div>
