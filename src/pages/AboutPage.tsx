          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                At MindCare, we believe that mental wellness should be accessible to everyone. 
            ...
            <div className="flex items-center justify-center">
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <Brain size={64} className="text-brand-600" />
                </div>
                <div className="absolute w-full h-full border-4 border-brand-400 rounded-full" />
              </motion.div>
            </div>
          </div>
        </animated.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="h-12 w-12 bg-brand-50 text-brand-600 rounded-lg flex items-center justify-center mb-4">
                {feature.icon}
              </div>
