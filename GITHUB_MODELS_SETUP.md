...
### 6. Test the Integration GitHub Models API integration for MindCare using the Azure REST client.
...
3. Give your token a descriptive name (e.g., "MindCare Chat API")
